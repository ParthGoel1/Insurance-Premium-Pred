...
model_rest = load("/Users/study/Desktop/ML Projects/Insurance Premium Prediction/app/artifacts/model_rest.joblib")
model_young = load("/Users/study/Desktop/ML Projects/Insurance Premium Prediction/app/artifacts/model_young.joblib")

scaler_rest = load("/Users/study/Desktop/ML Projects/Insurance Premium Prediction/app/artifacts/scaler_rest.joblib")
scaler_young = load("/Users/study/Desktop/ML Projects/Insurance Premium Prediction/app/artifacts/scaler_young.joblib")
...
def handle_scaling(age, df):
	...
	df.drop('income_level', axis = 'columns')
	return df


def predict(input_dict):
	input_df = preprocess_input(input_dict)
	input_df = input_df.drop(columns=['income_level'])
